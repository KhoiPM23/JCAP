...
namespace JCAP.Migrations
{
    ...
    [Migration("20260926010147_ConnectRoleplayResultsToSessions")]
    partial class ConnectRoleplayResultsToSessions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JCAP.Models.RoleplayResult", b =>
                {
                    b.HasOne("JCAP.Models.RoleplaySession", "RoleplaySession")
                        .WithOne("Result")
                        .HasForeignKey("JCAP.Models.RoleplayResult", "RoleplaySessionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
